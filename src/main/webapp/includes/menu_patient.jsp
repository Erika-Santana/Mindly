	...
	<nav
		...
		<img src="images/cerebro_icone.png" alt="ícone do cérebro" class="h-8 w-8 mr-2" /></a>
		...
		<div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
			<div class="text-sm lg:flex-grow">
					...
					Sobre nós </a> <a href="controller.do?action=clickTeamProfessionals"
					class="block mt-4 lg:inline-block lg:mt-0 text-purple-200 hover:text-purple mr-4">
					Conheça a nossa equipe </a> <a href="controller.do?action=clickAppointment"
					class="block mt-4 lg:inline-block lg:mt-0 text-purple-200 hover:text-purple mr-4">
					Agende com um profissional </a> <a href="controller.do?action=clickContactUs"
