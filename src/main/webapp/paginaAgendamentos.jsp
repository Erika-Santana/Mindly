...
<%
    ...
    } else if (professional != null && professional.getProfileImage() != null && !professional.getProfileImage().isEmpty()) {
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div class="md:col-span-1">
                <div class="bg-white border border-gray-200 rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                    <div class="p-4 text-center sacramento-regular text-purple">
                        <h3 class="text-lg font-semibold" style="font-size: 24px">Meu Perfil</h3>
                    </div>
                    <div class="p-4">
                        <div class="flex justify-center mb-4">
                            <img class="w-24 h-24 rounded-full object-cover border-4 border-purple-200" 
                                 src="<%= fotoPerfil %>" 
                                 alt="Foto do perfil">
                        </div>
                        ...
                        <div class="mt-4 pt-4">
                            <p class="text-sm text-gray-600"><strong>Contato:</strong> 
            ...
            <div class="md:col-span-3">
                <h2 class="text-2xl font-bold text-gray-800 mb-6">Profissionais Disponíveis</h2>
                        ...
                        <div class="p-6 md:w-3/4">
                            ...
                            <div class="mt-4">
                                ...
                                <div class="flex flex-wrap gap-2 mt-2">
                                    <% 
                                    	List<String> listSpecialty = prof.getSpecialty();
