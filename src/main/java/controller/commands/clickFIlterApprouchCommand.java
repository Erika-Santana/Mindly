...
public class clickFIlterApprouchCommand implements Command {
	...
	public String execute(HttpServletRequest req, HttpServletResponse resp) {
		...
		try {
		    String approach = req.getParameter("search-dropdown"); 
		    int page = 1;
		    int pageSize = 5;
		    ...
		    List<Professional> professionals = repositorio.listProfessionalsByApproach(approach, page, pageSize);
		    int totalProfessionals = repositorio.countProfessionalsByApproach(approach);
		    ...
		    if (session.getAttribute("cliente") != null) {
		        ...
		        req.setAttribute("approach", approach);
		    } else {
